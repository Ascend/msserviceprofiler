...
- 传播项目：在博客文章、社交媒体上分享msServiceProfiler，或给仓库点个⭐。
...
此外，您可以通过查看[Issues列表](https://gitcode.com/Ascend/msserviceprofiler/issues)了解项目的发展计划和路线图。
...
在提交代码前，请确保所有测试通过：
   ...
   bash run_ut.sh ms_service_profiler # 或 bash run_ut.sh ms_serviceparam_optimizer 或 bash run_ut.sh msservice_advisor
...
覆盖率报告在${CURRENT_DIR}/coverage/coverage.xml，其中`CURRENT_DIR`为当前执行的run_ut.sh脚本所在目录（即test目录）
...
5. **代码审查**
   ...
   Pull Request流程中会提示相关的“负责人”，可在Pull Request流程中指定相关“负责人”，或通过[README](README.md#)的建议与交流章节联系我们。
...
- **微信群**：日常交流和快速问答（参见[README](README.md)的建议与交流章节）

## 许可证

通过向本项目贡献代码，您同意您的贡献将按照项目的许可证进行授权。详见[LICENSE](LICENSE)文件。

msServiceProfiler工具docs目录下的文档适用CC-BY 4.0许可证，详见[docs/LICENSE](./docs/LICENSE)。

## 致谢

感谢您为msServiceProfiler做出的贡献。您的努力使这个项目变得更加强大和用户友好。期待您的参与！

---

如有任何疑问或需要帮助，请随时在[Issues](https://gitcode.com/Ascend/msserviceprofiler/issues)中提问，或通过其他社区渠道与我们联系。
